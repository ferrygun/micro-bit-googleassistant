...
EVENTSERVICE_SERVICE = 'E95D93AF-251D-470A-A062-FA1922DFA9A8'
MICROBITEVENT_CHARACTERISTIC = 'E95D9775-251D-470A-A062-FA1922DFA9A8'
CLIENTREQUIREMENTS_CHARACTERISTIC = 'E95D23C4-251D-470A-A062-FA1922DFA9A8'
CLIENTEVENT_CHARACTERISTIC = 'E95D5404-251D-470A-A062-FA1922DFA9A8'
...
class Microbit:
    ...
    def __init__(self, name=None, address=None):
        ...
        self.eventservice_service_path = None
        self.event_characteristic_path = None
        self.clientrequirements_characterstic_path = None
        self.clientevent_characteristic_path = None
        ...
        self.event_characteristic_iface = None
        self.event_client_req_characteristic_iface = None
        self.event_client_evt_characteristic_iface = None
    ...
    def _get_dbus_paths(self):
        ...
        self.temp_period_path = tools.uuid_dbus_path(
            constants.GATT_CHRC_IFACE,
            TEMP_PERIOD)[0]
        self.eventservice_service_path = tools.uuid_dbus_path(
            constants.GATT_SERVICE_IFACE,
            EVENTSERVICE_SERVICE)[0]
        self.event_characteristic_path = tools.uuid_dbus_path(
            constants.GATT_CHRC_IFACE,
            MICROBITEVENT_CHARACTERISTIC)[0]
        self.clientrequirements_characterstic_path = tools.uuid_dbus_path(
            constants.GATT_CHRC_IFACE,
            CLIENTREQUIREMENTS_CHARACTERISTIC)[0]
        self.clientevent_characteristic_path = tools.uuid_dbus_path(
            constants.GATT_CHRC_IFACE,
            CLIENTEVENT_CHARACTERISTIC)[0]
    ...
    def _config_dbus_ifaces(self):
        ...
        self._config_event_characteristic_iface()
        self._config_event_client_req_characteristic_iface()
        self._config_event_client_evt_characteristic_iface()
    ...
    def _config_event_characteristic_iface(self):
        event_characteristic_obj = tools.get_dbus_obj(constants.BLUEZ_SERVICE_NAME,
                                       self.event_characteristic_path)
        self.event_characteristic_iface = tools.get_dbus_iface(constants.GATT_CHRC_IFACE,
                                                event_characteristic_obj)

    def _config_event_client_req_characteristic_iface(self):
        event_client_req_characteristic_obj = tools.get_dbus_obj(constants.BLUEZ_SERVICE_NAME,
                                       self.clientrequirements_characterstic_path)
        self.event_client_req_characteristic_iface = tools.get_dbus_iface(constants.GATT_CHRC_IFACE,
                                                event_client_req_characteristic_obj)

    def _config_event_client_evt_characteristic_iface(self):
        event_client_evt_characteristic_obj = tools.get_dbus_obj(constants.BLUEZ_SERVICE_NAME,
                                       self.clientevent_characteristic_path)
        self.event_client_evt_characteristic_iface = tools.get_dbus_iface(constants.GATT_CHRC_IFACE,
                                                event_client_evt_characteristic_obj)
    ...
    def event_config(self):
        self.event_client_req_characteristic_iface.WriteValue([0x28, 0x23, 0x00, 0x00], ())
    ...
    def heart_animate_start(self):
        #9000
        self.event_client_evt_characteristic_iface.WriteValue([0x28, 0x23, 0x28, 0x23], ()) 

    def heart_animate_stop(self):
        #9001
        self.event_client_evt_characteristic_iface.WriteValue([0x28, 0x23, 0x29, 0x23], ()) 
